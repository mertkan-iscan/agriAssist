...
//
//        Day day = new Day(startOfDay, sunrise, sunset, plant);
...
//            int minuteOfDay = hourIndex * 60;
//
//            // Check if an Hour already exists for this day and minuteOfDay
//            boolean exists = day.getHours().stream()
//                    .anyMatch(hour -> hour.getMinuteOfDay() == minuteOfDay);
//
//            if (exists) {
//                continue; // Skip if a record already exists
//            }
//
...
//
//            Hour hourRecord = createHourRecord(field, minuteOfDay, weatherValues, solarValues, plant, day);
//
